...
def generate_launch_description():
    return LaunchDescription([
        # Forwarded to hyper_lane_detection's input_backend parameter, and with it the whole
        # stage's camera: the vehicle has one camera feeding both detectors, and intra_process is
        # what launches its driver (inside lane_detection's container). real.launch.py and
