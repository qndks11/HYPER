...
| `hyper_planner` | `src/planning/hyper_planner/README.md` | mission step queue, nav2 `follow_path`, cmd_vel→Ackermann, mission `keepout:` polygons → KeepoutFilter mask |
...
| `hyper_lane_detection` | `src/perception/hyper_lane_detection/README.md` | lane/stopline from camera, BEV |
...
| `hyper_waypoint_studio` | `src/tools/hyper_waypoint_studio/README.md` | one GUI to view/edit/record courses, edit mission labels/cones/keepout zones, and run a mission from mid-sequence |
